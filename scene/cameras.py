...
class Camera(nn.Module):
    def __init__(
        ...
        self.depth_params = depth_params if depth_params is not None else {}
        self.time = time
...
class MiniCam:
    def __init__(self, width, height, fovy, fovx, znear, zfar, world_view_transform, full_proj_transform, time=0.0,
                 is_test=False):
        self.is_test = is_test
